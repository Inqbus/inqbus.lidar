...
PRODUCT_SPECIFIC_GLOBAL_ATTS = {'input_file': {},
                                'history': {},
                }
...
VARIABLE_ATTRIBUTES = { 'altitude': {'dims': ('altitude'),
                                     'attrs':{'long_name': "height above sea level",
                                     'units': "m",
                                     'axis': "Z",
                                     'positive': "up",
                                     'standard_name': "altitude"}},
                        'vertical_resolution': {'dims': ('wavelength', 'time', 'altitude'),
                                                'attrs':{'long_name': "effective vertical resolution according to Pappalardo et al., appl. opt. 2004",
                                                        'units': "m",
                                                         '_FillValue': None,
                                                         }},
                        'cloud_mask': {'dims': ('time', 'altitude'),
                                     'attrs':{'long_name': "cloud mask",
                                       'units': "1",
                                       'flag_masks': np.array([1,2,4], dtype = np.int8), #1B, 2B, 4B
                                       'flag_meanings': "unknown_cloud cirrus_cloud water_cloud",
                                       'valid_range': (0, 7),
                                       '_FillValue': NC_FILL_BYTE,
                                       }},

                        'backscatter': {'dims': ('wavelength', 'time', 'altitude'),
                                     'attrs':{'long_name': "aerosol backscatter coefficient",
                                        'units': "1/(m*sr)",
                                        'ancillary_variables': "error_backscatter vertical_resolution",
                                        'coordinates': "longitude latitude",
                                        '_FillValue': None,
                                         }},
                        'error_backscatter': {'dims': ('wavelength', 'time', 'altitude'),
                                     'attrs':{'long_name': "absolute statistical uncertainty of backscatter",
                                             'units': "1/(m*sr)",
                                             'coordinates': "longitude latitude",
                                             '_FillValue': None,
                                              }},

                        'extinction': {'dims': ('wavelength', 'time', 'altitude'),
                                     'attrs':{'long_name': "aerosol extinction coefficient",
                                       'units': "1/m",
                                       'ancillary_variables': "error_extinction vertical_resolution",
                                       'coordinates': "longitude latitude",
                                       '_FillValue': None,
                                       }},
                        'error_extinction': {'dims': ('wavelength', 'time', 'altitude'),
                                     'attrs':{'long_name': "absolute statistical uncertainty of extinction",
                                             'units': "1/m",
                                             'coordinates': "longitude latitude",
                                             '_FillValue': None,
                                             }},

                        'volumedepolarization' :{'dims': ('wavelength', 'time', 'altitude'),
                                     'attrs':{'long_name': "volume linear depolarization ratio",
                                                 'ancillary_variables': "error_volumedepolarization vertical_resolution",
                                                 'coordinates': "longitude latitude",
                                                 'units': '1',
                                                 '_FillValue': None,
                                                 }},
                        'error_volumedepolarization': {'dims': ('wavelength', 'time', 'altitude'),
                                     'attrs':{'long_name': "absolute statistical uncertainty of volumedepolarization",
                                                       'coordinates': "longitude latitude",
                                                        'units': '1',
                                                       '_FillValue': None,
                                                       }},

                        'particledepolarization': {'dims': ('wavelength', 'time', 'altitude'),
                                     'attrs':{'long_name': "particle linear depolarization ratio",
                                                   'ancillary_variables': "error_particledepolarization vertical_resolution",
                                                   'coordinates': "longitude latitude",
                                                    'units': '1',
                                                   '_FillValue': None,
                                                   }},
                        'error_particledepolarization': {'dims': ('wavelength', 'time', 'altitude'),
                                     'attrs':{'long_name': "absolute statistical uncertainty of particledepolarization",
                                                         'coordinates': "longitude latitude",
                                                         'units': '1',
                                                         '_FillValue': None,
                                                         }},
